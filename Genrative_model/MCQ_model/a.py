...
if st.session_state.page == "Upload":
    ...
    if st.session_state.generated_questions:
        ...
        # Now use the updated regex patterns to separate MCQs, short answers, and answers
        text = st.session_state.generated_questions  # Use the generated questions as input text

        # Extract MCQ questions, options, and answers
