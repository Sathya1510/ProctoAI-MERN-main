...
# Load image (use the uploaded image path or replace with your uploaded file path)
uploaded_image_path = "featured-1.jpg"  # Update with your uploaded file path
...
# Function to display the test instructions page
def show_test_instructions():
    col1, col2 = st.columns([3, 2])  # Left column wider for image

    # Left column - Full screen image display
    with col1:
        st.image(uploaded_image, use_column_width=True)

    # Right column - Test instructions and checkbox
    with col2:
        st.header("Description")
        st.markdown("""
        This practice test allows you to assess your Python skills at a beginner level through multiple-choice questions. Aim for at least 75% before moving to the next level.
        """)
        st.header("Test Instructions")
        st.markdown("""
        1. **DSA questions only**.
        2. **Do not switch tabs**. Switching tabs will block/end the test.
        3. **Full-screen mode only**. Switching back to tab mode will end the test.
        4. Questions can be reattempted while the test is running.
        5. Click "Finish Test" once done.
        """)
        
        st.subheader("Confirmation")
        st.write("Your actions are proctored. Any wrongdoing may lead to test suspension or cancellation.")

        # Confirmation checkbox
        agree = st.checkbox("I certify that I have carefully read and agree to all of the instructions mentioned above")
...
# Function to display coding practice page
def show_test_page():
